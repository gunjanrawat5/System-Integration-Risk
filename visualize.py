...
# 2) Gephi NODES file
# -----------------------------
# Gephi wants an "Id" column that matches the Source/Target in edges.
# We'll use the human-readable node name as the Id.
...
# (Optional) if you don't want the original "node" column duplicated:
# gephi_nodes = gephi_nodes.drop(columns=["node"])

# This keeps risk_label, importance_score, centralities, etc. as node attributes.
